本示例程序的运行依赖于下述开源项目提供的深度神经网络模型文件:
https://github.com/jcjohnson/fast-neural-style
该开源项目公开了斯坦福大学李飞飞教授和他的博士生Justin Johnson等发表于ECCV 2016的文章
Perceptual Losses for Real-Time Style Transfer and Super-Resolution的代码和模型。

请读者通过下述链接下载，并存入项目的models子目录:
